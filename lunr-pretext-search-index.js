...
},
{
  "id": "def-linear-map",
  "level": "2",
  "url": "section-vectors-matrices-linear-systems.html#def-linear-map",
  "type": "Definition",
  "number": "1.1.41",
  "title": "Linear Map Defined by a Matrix.",
  "body": " Linear Map Defined by a Matrix   Let . The map is called the linear map defined by  .   "
},
{
  "id": "ex-rotation-matrix",
  "level": "2",
  "url": "section-vectors-matrices-linear-systems.html#ex-rotation-matrix",
  "type": "Example",
  "number": "1.1.42",
  "title": "Rotation in <span class=\"process-math\">\\(\\mathbb{R}^2\\)<\/span> as a Linear Map.",
  "body": " Rotation in as a Linear Map  A rotation about the origin through an angle is described by the matrix   For example, if , then   Applying this matrix to the vector gives   Hence, the vector is rotated by counterclockwise.  "
},
{
  "id": "ex-column-interpretation-linear-map",
  "level": "2",
  "url": "section-vectors-matrices-linear-systems.html#ex-column-interpretation-linear-map",
  "type": "Example",
  "number": "1.1.43",
  "title": "The Columns of a Matrix Determine the Linear Map.",
  "body": " The Columns of a Matrix Determine the Linear Map  Consider   Its columns are   For a vector we have   This shows that the image of under the linear map defined by is obtained as a linear combination of the columns of .  "
},
{
